document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        fr: {
            ...
            exp_3_p: "Allier l'intégrité IFRS à l'ingénierie de données via Python pour une fiabilité institutionnelle.",
            ...
            skills_g5: "Modélisation Financière et Évaluation",
        ...
        ar: {
            ...
            hero_tagline: "هندسة تقاطع النزاهة المحاسبية والذكاء المالي المدعوم بالذكاء الاصطناعي.",
            ...
            proj_f_p: "XGBoost مصنف احتيال يحقق دقة 91٪ مع تقليل بنسبة 30٪ في الإيجابيات الكاذبة - مدمج مع نظام توصية مالي يعتمد على المحولات.",
            ...
            exp_3_title: "التوليف التقني",
            exp_3_p: "المطابقة بين نزاهة المعايير الدولية للتقارير المالية (IFRS) وهندسة البيانات باستخدام لغة بايثون لضمان موثوقية مؤسسية.",
